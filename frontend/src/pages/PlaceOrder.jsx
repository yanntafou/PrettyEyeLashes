...
const PlaceOrder = () => {
    ...
    const onChangeHandler = (event) => {
        const name = event.target.name; //we get the name of the fields
        const value = event.target.value; //we get the value of the field

        setFormData(data => ({ ...data, [name]: value })) //we update our different input fields xith the onChangeHandler
        ...
        <form onSubmit={onSubmitHandler} className="flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t">
            ...
            <div className="flex flex-col gap-4 w-full sm:max-w-[480px] ">
                ...
                <div className="flex gap-3">
                    ...
                    <input onChange={onChangeHandler} name='appartement' value={formData.appartement} className="border border-gray-300 rounded py-1.5 px-3.5 w-full" type="text" placeholder="Appartement #" />
                </div>
            ...
            <div className="mt-8">
                ...
                <div className="mt-12">
                    ...
                    <div className="w-full text-end mt-8">
                        <button type="submit" className="bg-[#dc5796] hover:bg-[#12113b] duration-500 text-white px-16 py-3 text-sm">PLACE ORDER</button>
                    </div>
